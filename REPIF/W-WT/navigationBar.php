<ul class="nav bg-dark">
    <?php
        function addNavLink($pageLink,$pageText){
            ...
            $navigationLinks=["index.php"=>"Home", "sbManagement.php"=>"SmartBox Management", "pinManagement.php"=>"Pin Management", "groups.php"=>"Groups", "script.php"=>"Scripts", "userManagement.php"=>"Users", "userConfiguration.php"=>"Configuration"];
